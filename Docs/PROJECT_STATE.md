...
- #100 — ObjectGenome↔MaterialDNA exact-reference/content-revision repair; **merged green via #121 and complete**.
...
- #125 — ObjectGenome support reachability must be cycle-independent/deterministic; **blocking Epic C exit**.
...
- ObjectGenome cycle rejection and external-support reachability report independent deterministic facts,
