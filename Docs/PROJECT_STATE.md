...
- #100 — ObjectGenome↔MaterialDNA exact-reference/content-revision repair; **merged via #121 with deterministic fingerprint closure #129 and complete**.
...
- ObjectGenome material references obey the exact landed MaterialDNA identity/revision contract and same-version canonical recipe drift is detectable through an explicit versioned deterministic seal,
