...
- Request `20260810-032-performance-observation-090e-sol56s9` on exact UNRENDERED SHA `090e112c83126ebe8e6f9ba75f27b7bcc31dc3af` is accepted bounded `physics-lab-performance-observation` evidence: the stored Studio server RunMode payload records Roblox engine `0.733.0.7330989`, 30 warmup + 120 measured Heartbeats (mean 17.785 ms, median 16.692 ms, p95 18.304 ms, max 93.643 ms), full-capture/restart observations, exact canonical WorldId/RegionId/fingerprint/repro identity, zero tracked restart resource deltas, and the documented 0.001-stud envelope preserved. After bridge #65 and #75 hardened aggregate/resource validation, bridge #78 (`d9805bbf24d865dc6286d70a813a936b7ff0d123`) durably re-evaluated the complete stored request-032 evidence through the current evaluator; exact-head Bridge CI `31450117146` passed with `performance observations recorded; no budget asserted`. This satisfies the required corrected-evaluator re-evaluation for the measurement row. Fresh request `20260810-033-performance-post65-090e-sol56h3` timed out with no evidence and is not counted. No permanent frame-time/startup/device-suitability budget is asserted, and this row does not close the composite Hero Gate or unlock a feature.
