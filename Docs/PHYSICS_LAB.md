...
- exact MaterialDNA reference acceptance for structural primitives and fail-closed malformed-reference handling;
- valid ObjectGenome recipes, recipe fingerprints and default mutable state;
- manufacturable jamb/header door-frame construction that cannot regress to a solid aperture-filling slab;
