...
2. Fidelity Manager evaluates desired F0-F4 and applies hysteresis/holds/cooldown.
3. When eligible, the manager invokes `applyTransition` before touching its own mirror.
