...
class LegacyTrustSyncTests(unittest.TestCase):
    ...
    def test_all_v16_write_workflows_share_lock_and_reconcile_trust(self):
        ...
        shadow = (root / ".github/workflows" / "swarm-v16-shadow.yml").read_text(encoding="utf-8")
        preflight = shadow.split("  live-trusted-control-preflight:\n", 1)[1]
        self.assertIn("timeout-minutes: 120", preflight)
        self.assertIn("actions/checkout@v6", preflight)
